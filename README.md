...
请参考神策官网 [C# SDK 集成（A/B Testing）](https://manual.sensorsdata.cn/abtesting/latest/page-71401475.html)。

## 贡献

*
    1. 在您的 GitHub 账户下 fork abtesting-sdk-csharp 开源项目；
*
    2. 根据您的需求在本地 clone 一份 abtesting-sdk-csharp 源码；
*
    3. 您修改或者新增功能后，push 到您 fork 的远程分支；
*
    4. 创建 pull request，向 abtesting-sdk-csharp 官方开发分支提交合入请求；
*
